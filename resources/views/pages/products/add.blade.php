                    ...
                    <div class="card-block">
                        ...
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="quantity" id="quantity" class="form-control" placeholder="0" value="" />
                                    <!--<select name="quantity" id="quantity" class="form-control">-->
                                    <!--    <option value="1">1</option></option>-->
                                    <!--    <option value="500">500</option></option>-->
                                    <!--    <option value="250">250</option></option>-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="unit" id="unit" class="form-control">
                                        <option value="gm">gm</option></option>
