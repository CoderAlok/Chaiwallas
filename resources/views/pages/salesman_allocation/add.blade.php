    ...
    <div class="page-header">
        ...
        <div class="page-header-breadcrumb">
            <ul class="breadcrumb-title">
                ...
                <li class="breadcrumb-item"><a href="#!">Salesman Alloaction</a>
                </li>
                <li class="breadcrumb-item"><a href="#!">Add Salesman Alloaction</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="col-sm-8">
                        <form action="{{ url('/dashboard/salesman-allocation/add') }}" method="post">
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" name="submit" class="btn btn-primary">Allocate</button>
                                </div>
                            </div>
